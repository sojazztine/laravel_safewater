<x-public-layout>
            ...
            <div class="">
                <div class="flex items-center p-5">
                    ...
                    <div class="border w-[90%] rounded-xl bg-[#EBFCFC] p-5">
                        <h1 class="text-[#016262] text-xs sm:text-sm md:text-base lg:text-lg">
                            https://www.facebook.com/restoresolutionsph</h1>
                    </div>
                </div>
                <div class="flex items-center p-5">
                    ...
                    <div class="border w-[90%] rounded-xl bg-[#EBFCFC] p-5">
                        <h1 class="text-[#016262] text-xs sm:text-sm md:text-base lg:text-lg">
                            https://www.instagram.com/restoresolutionsph</h1>
                    </div>
                </div>
                <div class="flex items-center p-5">
                    ...
                    <div class="border w-[90%] rounded-xl bg-[#EBFCFC] p-5">
                        <h1 class="text-[#016262] text-xs sm:text-sm md:text-base lg:text-lg">
                            https://youtube.com/@restoresolutionsph</h1>
                    </div>
                </div>
                <div class="flex items-center p-5">
                    ...
                    <div class="border w-[90%] rounded-xl bg-[#EBFCFC] p-5">
                        <h1 class="text-[#016262] text-xs sm:text-sm md:text-base lg:text-lg">
                            https://www.tiktok.com/@restoresolutions</h1>
                    </div>
                </div>
                <div class="flex items-center p-5">
                    ...
                    <div class="border w-[90%] rounded-xl bg-[#EBFCFC] p-5">
                        <h1 class="text-[#016262] text-xs sm:text-sm md:text-base lg:text-lg">
                            https://www.linkedin.com/@restoresolutionsph</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- MODAL -->
    <div id="modal"
        class="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 hidden">
        <div
            class="relative flex flex-col items-center border rounded-3xl w-[90%] md:w-[50%] lg:w-[40%] p-8 bg-white shadow-lg">
            <!-- Close Button -->
            <button onclick="closeModal()"
                class="absolute top-5 right-5 text-gray-500 hover:text-gray-700 text-4xl">&times;</button>

            <div class="text-center mb-[30px] w-full">
                <h1 class="text-3xl font-bold mt-10 mb-3">Get in touch with us</h1>
                <h1 class="text-sm md:text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex flex-col md:flex-row md:space-x-4 w-full">
                        ...
                        <div class="flex flex-col w-full md:w-1/2 mt-4 md:mt-0">
                            ...
                            <input name="last_name" type="text" id="surname"
                                class="mt-1 px-3 py-2 border border-gray-300 rounded-md">
                        </div>
                    </div>
    ...
    <div class="flex justify-center px-4">
        <div class="w-full sm:w-[50%] md:w-[40%] lg:w-[30%] text-center flex flex-col items-center justify-center">
            <h1 class="my-5 text-lg sm:text-xl md:text-2xl">Got any questions about our product, solutions, or
                initiatives? We're here to help you contribute to a cleaner, greener future. Let's talk!</h1>
