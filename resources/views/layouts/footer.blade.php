<footer class="min-h-[300px] bg-[#016262]">
    <div class="flex justify-end px-5 md:px-20 pt-10">
    ...
    <div class="flex justify-center mt-5 mb-5">
        <div class="w-[90%] text-white flex flex-col md:flex-row gap-5 md:gap-10">
            <div class="flex flex-col me-10">
                ...
                <a href="" class="mb-2 text-md hover:underline">Restore Furniture and Applications</a>
            ...
            <div class="flex flex-col me-10">
                ...
                <a href="" class="mb-2 text-md hover:underline">The Team</a>
                <a href="" class="mb-2 text-md hover:underline">The EPR Act</a>
                <a href="" class="mb-2 text-md hover:underline">Community Collections</a>
            </div>
            ...
            <div class="flex flex-col">
                ...
                <div class="flex items-center">
                    ...
                    <a href="" class="text-md hover:underline">Facebook Page</a>
                </div>
                <div class="flex items-center">
                    <img src="{{asset('img/img-footer/instagram.png')}}" class="invert h-8 me-2 p-1" alt="">
                    <a href="" class="text-md hover:underline">Instagram</a>
                </div>
                <div class="flex items-center">
                    <img src="{{asset('img/img-footer/youtube.png')}}" class="invert h-8 me-2 p-1" alt="">
                    <a href="" class="text-md hover:underline">Youtube</a>
                </div>
                <div class="flex items-center">
                    <img src="{{asset('img/img-footer/tiktok.png')}}" class="invert h-8 me-2 p-1" alt="">
                    <a href="" class="text-md hover:underline">Tiktok</a>
                </div>
                <div class="flex items-center">
                    <img src="{{asset('img/img-footer/linkedin.png')}}" class="invert h-8 me-2 p-1" alt="">
                    <a href="" class="text-md hover:underline">LinkedIn</a>
                </div>
            </div>
        </div>
    </div>
