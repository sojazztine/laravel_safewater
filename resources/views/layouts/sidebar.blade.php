             ...
             <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full mt-[65px] px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                   <ul class="space-y-2 font-medium">
                      <li>
                         <a href="{{route('dashboard')}}" class="{{request()->is('dashboard') ? 'flex items-center p-2 text-gray-900 rounded-lg bg-gray-200 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group' : 'flex items-center' }}">
                      ...
                      <li>
                         <a href="{{ route('post_blog')}}" class="{{request()->is('post_blog') ? 'flex items-center p-2 text-gray-900 rounded-lg bg-gray-200 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group' : 'flex items-center' }}">
