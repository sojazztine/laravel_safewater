<x-sidebar-layout>
    ...
    <div class="mt-[50px] ml-5">
        <div class="flex gap-5">
            ...
            <h1 class="text-[#016262] text-xl">Create a new partner</h1>
        </div>


        <card class="block max-w-2xl mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow-sm ">

            <form class="max-w-md mx-auto" method="POST" action="{{ route('partner-management.store') }}" enctype="multipart/form-data" id="user_form">
                @csrf
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" name="company_name" id="company_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
